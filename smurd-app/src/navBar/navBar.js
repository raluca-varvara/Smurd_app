    ...
    return(
        <div className='color-nav'>
            ...
            <div className="nav-buttons-div">
                ...
                <Button  className = "nav-button"  onClick={() => navigate("/volunteer")}>Become a volunteer</Button>
                <Button  className = "nav-button" onClick={() => navigate("/kits")} >First Aid Kits</Button>
                
            </div>

            <div className="signUpDiv">
                <Button  className = "color-button"  onClick={() => navigate("/login")} >LogIn</Button>
